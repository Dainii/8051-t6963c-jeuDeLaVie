M:stdio_t6963c
F:G$STDIO_initialize$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$STDIO_startWritingAt$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$putchar$0$0({2}DF,SC:S),C,0,0,0,0,0
S:LSTDIO_startWritingAt$y$1$1({1}SC:U),F,0,0
S:LSTDIO_startWritingAt$x$1$1({1}SC:U),F,0,0
S:Lputchar$c$1$1({1}SC:S),F,0,0
S:G$address$0$0({2}SI:U),F,0,0
...
S:Fstdio_t6963c$__xinit_address$0$0({2}SI:U),C,0,0
